	...
	<td>
		<table width="100%">
			<tr>
				...
				<form method="get" action="index.php" id="searchform" style="width:170px">
					...
					<!--
					spi=prop-id, spv=prop-value,
					spc=compare (greater/lesser)
					,spt (property type), 
					spg=grouping no.
					-->
					<input type="hidden" name="spi[]" value="35" />
					<input type="hidden" name="spv[]" value="2" />
					<input type="hidden" name="spc[]" value="0" />
...
<br />
        ...
        <a ><!--getandputsubcats_public - see includes\js\page_functions.js-->
