  ...
  <tr>
    ...
    <td>
		...
		<xsl:attribute name="href">
			?target_component[]=RecordIniFacade&amp;target_function[]=initialize&amp;eid=<xsl:value-of select="@eid" />&amp;type_id=<xsl:value-of select="@type_id" />&amp;output_function=show_purchasable_product</xsl:attribute>
