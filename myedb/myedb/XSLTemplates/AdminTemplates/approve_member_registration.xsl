...
<xsl:include href="PageContents/approve_member_registration_pgct.xsl" />
<xsl:include href="../include/head_includes.xsl"/>
<xsl:include href="../include/templates/generic/property.xsl"/>
<xsl:include href="../include/templates/PersonEditor/approve_member_registration_property.xsl"/>

<xsl:include href="../include/templates/generic/multi_phone.xsl"/>
<xsl:include href="../include/templates/PersonEditor/approve_member_registration_record.xsl"/>
