...
<xsl:include href="page_sections/admin_search_users_form.xsl"/>
...
<html>
  <head>
	...
	var cur_page_no;
	var	searchrestbl_url = '?target_component[]=RecordIniFacade&amp;target_function[]=filtered_search_by_mixed_criteria&amp;OF_passthru=search_admin_user_results';
    </script>
    <style type="text/css">
      <![CDATA[
      <!--
  ...
  <tr>
    ...
    <td valign="top"><div align="center">
		...
		<xsl:attribute name="href">
			?target_component[]=RecordIniFacade&amp;target_function[]=initialize&amp;eid=<xsl:value-of select="@eid" />&amp;type_id=<xsl:value-of select="@type_id" />&amp;OF_passthru=edit_person_admin</xsl:attribute>
