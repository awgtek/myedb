...
<input type="hidden" name="target_function[]" value="update_record" />
	 ...
	 <table border="0" width="100%">
	 	<tr><td> </td>
			<td rowspan="10"><p>Level 1 --- Able to view – No Updating allowed</p>
			  
			  <p>Level 2 --- View; add; and update   “products”</p>
		      
			  <p>Level 3 -- View; add; and update   “products”</p>
			  <blockquote>
			    <p>Ability to   modify “ticket” Quantities &amp; pricing</p>
		      </blockquote>			  
			  <p>Level 4 – Super user --- Ability   to update &amp; Delete all areas of admin</p>		    
			  
			  <p>Level -1 – Public user --- Able to view only public site as a member</p>		    
			  </td>
		</tr>
