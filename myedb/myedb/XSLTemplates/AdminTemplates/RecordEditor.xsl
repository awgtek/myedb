...
<xsl:include href="../include/templates/RecordEditor/record.xsl"/>
...
<!-- <xsl:template match="/">
 Hey! Welcome to <xsl:value-of select="$owner"/>'s sweet CD collection! 
  ...
  <xsl:key name="product_detail_line" match="property[@prop_group_id='2']" use="@ron" />
	...
	<xsl:key name="category_by_id" match="/myedbroot/categories/category" use="@cat_id" />
	<xsl:key name="subcategory_by_id" match="/myedbroot/subcategories/subcategory" use="@subcat_id" />
