// JavaScript Document
//adapted code from http://www.java2s.com/Code/JavaScript/Form-Control/ACSSisusedtohighlightthefieldswhichfailedtovalidate.htm
function validateCompleteForm(objForm,strErrorClass){ //alert("yo"); return false;
...
//alert(element.getAttribute('realname') + ":" + regex.slice(nBegin,nEnd));
