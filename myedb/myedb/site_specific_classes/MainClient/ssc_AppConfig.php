...
class ssc_AppConfig
{
	...
	var $persisted_paged_search_keys = array("cspi","cspv","cspve"=>"remove_when_absent","cspvi"=>"remove_when_absent","spi","spv","type_id","srtpi","output_function","search_res_row_cnt","spc","spt","spg");
	var $AC_server;
	var $AC_user;
	var $AC_pass;
	var $AC_db;
